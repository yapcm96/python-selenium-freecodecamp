A project I followed on a Youtube tutorial to learn about using Selenium to create a web scraping bot: https://www.freecodecamp.org/news/use-selenium-to-create-a-web-scraping-bot/
